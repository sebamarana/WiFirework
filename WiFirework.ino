...
<!DOCTYPE html>
<!-- style="width: 400px; height: 250px; font-size: 30px;" -->
<html>
  <head>
      <meta charset="UTF-8">
  ...
  <body style="font-family: 'Roboto', sans-serif;">
    <center>
      <div class="all"> 
        ...
        <!-- <a href="ledOn" class="element"><button type="button" style="width: 90%; height: 200px; font-size: 23px;">LED ON</button><br><br></a>
        <a href="ledOff" class="element"><button type="button" style="width: 90%; height: 200px; font-size: 23px;">LED OFF</button></a>
        <br><br><hr>-->
        <a href="ledOn"><button class="detonateButton">DETONATE!</button></a>
      </div>
    </center>
